...
def haversine_km(lat1, lon1, lat2, lon2):
 ...
 def add_google_distance_time(
     ...
     # 1) filtro por raio via haversine
     df["dist_km"] = df.apply(
     ...
     # Observação: Distance Matrix tem limite de 25 destinos por request. :contentReference[oaicite:3]{index=3}
...
# # ---------- UI ----------
 ...
 # filtro local (geodesic só pra “visual” e coerência com seu notebook)
 df_local = df.copy()
